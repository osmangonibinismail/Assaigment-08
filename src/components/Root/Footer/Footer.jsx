        ...
        <div className="max-w-6xl mx-auto pt-20">
                ...
                <nav>
                    <form>
                        ...
                        <fieldset className="form-control w-80">
                            <span className="label-text">Name: Osman Goni</span>
                            <span className="label-text">Mobile: 01912093654</span>
                            <span className="label-text">Banskhali, Chittagong</span>
                        </fieldset>
                    </form>
                </nav>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>OAI Compani Limited<br />Providing reliable tech since 2024</p>
                </aside>
                <aside>
